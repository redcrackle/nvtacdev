    ...
    })(
        {
            ...
            2: [
                function (e, n) {
                    function f(e, n, f) {
                        !e.defaultView ||
                            (n === e.defaultView.pageXOffset && f === e.defaultView.pageYOffset) ||
                ...
                function (e, n) {
                    ...
                    (f.prototype.findImages = function (e) {
                        ...
                        (f.prototype.loadImage = function (e) {
                            if ("url" === e.method) {
                                var n = e.args[0];
                                return !this.isSVG(n) || this.support.svg || this.options.allowTaint
                            ...
                            return "linear-gradient" === e.method
                                ...
                                : "IFRAME" === e.method
                                ? new l(e.args[0], this.isSameOrigin(e.args[0].src), this.options)
                                : new i(e);
                        }),
                        ...
                        (f.prototype.getOrigin = function (e) {
                            ...
                            return (
                                (n.href = e), (n.href = n.href), n.protocol + n.hostname + n.port
                            );
                        }),
                ...
                function (e, n) {
                    ...
                    (f.prototype.cloneTo = function (e) {
                        ...
                        (f.prototype.parseBounds = function () {
                            return (
                                this.bounds ||
                                (this.bounds = this.hasTransform() ? c(this.node) : a(this.node))
                            );
                        }),
            ...
            15: [
                function (e, n) {
                    ...
                    function a(e, n, f, o, d, i, t) {
                        ...
                        return (
                            n[0] > 0 || n[1] > 0
                                ? (l.push(["line", o[1].start.x, o[1].start.y]), o[1].curveTo(l))
                    ...
                    function r(e) {
                        return (
                            -1 !==
                            ["inline", "inline-block", "inline-table"].indexOf(e.css("display"))
                        );
                    }
                    function v(e) {
                ...
                function (e, n) {
                    ...
                    (f.prototype = Object.create(d.prototype)),
                        ...
                        (f.prototype.setVariable = function (e, n) {
                            return (
                                this.variables[e] !== n && (this.variables[e] = this.ctx[e] = n),
                                this
                            );
                        }),
