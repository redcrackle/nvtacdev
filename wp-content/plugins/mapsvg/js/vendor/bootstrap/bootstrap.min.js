...
!(function (t, e) {
    ...
    P.on(document, "click.bs._button.data-api", '[data-bs-toggle="button"]', (t) => {
        t.preventDefault();
        const e = t.target.closest('[data-bs-toggle="button"]');
        let s = w.get(e, "bs._button");
    ...
    class lt extends M {
        ...
        static clearMenus(t) {
            if (t) {
                if (2 === t._button || ("keyup" === t.type && "Tab" !== t.key)) return;
    ...
    class _t extends M {
        ...
        static jQueryInterface(t) {
            return this.each(function () {
                const e =
                    w.get(this, "bs.offcanvas") || new _t(this, "object" == typeof t ? t : {});
                if ("string" == typeof t) {
    ...
    class Ht extends M {
        ...
        _getConfig(t) {
            if (
                "string" !=
                    typeof (t = { ...Pt, ...("object" == typeof t && t ? t : {}) }).target &&
                c(t.target)
            ) {
                let { id: e } = t.target;
