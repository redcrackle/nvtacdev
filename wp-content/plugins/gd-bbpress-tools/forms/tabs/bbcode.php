							...
							<?php foreach ( $_user_roles as $role => $title ) { ?>
                                <label for="bbcodes_special_roles_<?php echo $role; ?>">
                                    <input type="checkbox" <?php if ( ! isset( $options["bbcodes_special_roles"] ) || in_array( $role, $options["bbcodes_special_roles"] ) ) {
										echo " checked";
									} ?> value="<?php echo $role; ?>" id="bbcodes_special_roles_<?php echo $role; ?>" name="bbcodes_special_roles[]"/>
									<?php echo $title; ?>
                                </label><br/>
							<?php } ?>
                        </fieldset>
                ...
                <tr>
                    ...
                    <td>
                        <select id="bbcodes_special_action" name="bbcodes_special_action" class="regular-text">
							...
							} ?>><?php _e( 'Replace with notice', 'gd-bbpress-tools' ); ?></option>
                            <option value="delete"<?php if ( $options["bbcodes_special_action"] == "delete" ) {
								echo ' selected="selected"';
							} ?>><?php _e( 'Remove from content', 'gd-bbpress-tools' ); ?></option>
                        </select>
                    </td>
                </tr>
                </tbody>
        ...
        <fieldset>
            ...
            <table class="form-table d4p-bbcodes-table">
                ...
                <tr>
                    ...
                    <td><?php _e( 'Block', 'gd-bbpress-tools' ); ?></td>
                    <td>[div]{content}[/div]</td>
                </tr>
                <tr>
                    <th scope="row"><?php d4p_bbcode_selected( 'list', $options['bbcodes_deactivated'] ); ?></th>
                    <td><?php _e( 'List: Ordered', 'gd-bbpress-tools' ); ?></td>
            ...
            <table class="form-table d4p-bbcodes-table">
                ...
                <tr>
                    ...
                    <td><?php _e( 'YouTube Video', 'gd-bbpress-tools' ); ?></td>
                ...
                <tr>
                    ...
                    <td><?php _e( 'Vimeo Video', 'gd-bbpress-tools' ); ?></td>
